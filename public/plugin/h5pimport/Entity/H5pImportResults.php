...
class H5pImportResults
{
     ...
     * @var Course
     *
     * @ORM\ManyToOne(targetEntity="App\CoreBundle\Entity\Course")
     *
     ...
     * @var null|Session
     *
     * @ORM\ManyToOne(targetEntity="App\Session\Domain\Entity\Session")
     *
     ...
     * @var CLpItemView
     *
     * @ORM\ManyToOne(targetEntity="App\CourseBundle\Entity\CLp\CLpItemView")
     *
