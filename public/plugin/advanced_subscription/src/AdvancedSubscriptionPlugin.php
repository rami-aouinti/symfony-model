...
use App\CoreBundle\Hook\HookAdminBlock;
use App\CoreBundle\Hook\HookNotificationContent;
use App\CoreBundle\Hook\HookNotificationTitle;
use App\CoreBundle\Hook\HookWSRegistration;
use App\CoreBundle\Hook\Interfaces\HookPluginInterface;
...
class AdvancedSubscriptionPlugin extends Plugin implements HookPluginInterface
{
    ...
    private function getApprovedInductionSessions($userId)
    {
        ...
        $extraFieldType = \App\Platform\Domain\Entity\ExtraField::SESSION_FIELD_TYPE;
