...
use App\CourseBundle\Repository\CLpRelUserRepository;
use App\CourseBundle\Component\CourseCopy\CourseArchiver;
...
use App\CourseBundle\Entity\CLp\CLpItemView;
use App\Quiz\Domain\Entity\CQuiz;
use App\Quiz\Domain\Entity\Student\CStudentPublication;
...
class learnpath
{
    ...
    public static function isUserSubscribedToLp(
        ...
        foreach ($subscribedUsersInLp as $users) {
            /** @var \App\CourseBundle\Entity\CLp\CLpRelUser $users */
