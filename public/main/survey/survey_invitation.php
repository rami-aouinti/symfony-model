...
echo '</tr>';
$surveyAnonymousShowAnswered = ('true' === api_get_setting('survey.survey_anonymous_show_answered'));
$hideSurveyReportingButton = ('true' === api_get_setting('survey.hide_survey_reporting_button'));
