    ...
    case 'search_course':
        ...
        if ($showCourses) {
            ...
            if ($allowExtraFields) {
                ...
                $fieldsRepo = $em->getRepository(\App\Platform\Domain\Entity\ExtraField::class);
                $fieldTagsRepo = $em->getRepository(\App\Platform\Domain\Entity\ExtraFieldRelTag::class);
            }
