...
use App\CoreBundle\Entity\AccessUrlRelSession;
use App\CoreBundle\Entity\Course;
use App\CoreBundle\Entity\CourseRelUser;
use App\Platform\Domain\Entity\ExtraField as EntityExtraField;
use App\Sequence\Domain\Entity\SequenceResource;
use App\Session\Domain\Entity\Session as SessionEntity;
...
use App\CoreBundle\Component\Utils\ObjectIcon;
...
class CourseManager
{
    ...
    public static function unsubscribe_user($user_id, $course_code, $session_id = 0)
    {
        ...
        if ('true' === api_get_setting('session.catalog_course_subscription_in_user_s_session')) {
            ...
            /** @var App\CoreBundle\Entity\User $user */
    ...
    public static function get_logged_user_course_html(
        ...
        if (SkillModel::isAllowed($user_id, false)) {
            ...
            $skill = $em->getRepository(\App\CoreBundle\Entity\Skill\Skill::class)->getLastByUser($objUser, $objCourse, $objSession);
