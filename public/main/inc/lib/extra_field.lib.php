...
class ExtraField extends Model
{
    ...
    public function get_handler_field_info_by_tags($variable)
    {
        ...
        if (Database::num_rows($result)) {
            ...
            $extraFieldId = $row['id'];
            /** @var \App\Platform\Domain\Entity\ExtraField $extraField */
    ...
    public function get_all(array $options = []): array
    {
        ...
        if (!empty($extraFields)) {
            foreach ($extraFields as &$extraField) {
                ...
                /** @var \App\Platform\Domain\Entity\ExtraField $field */
    ...
    {
        $em = Database::getManager();
        $items = $em->getRepository(\App\Platform\Domain\Entity\ExtraFieldSavedSearch::class)->findBy(['field' => $id]);
        if ($items) {
