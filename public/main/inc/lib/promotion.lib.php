...
use App\CoreBundle\Entity\Promotion as PromotionEntity;
...
class Promotion extends Model
{
    ...
    {
        $promotion = new \App\CoreBundle\Entity\Promotion();

        $em = Database::getManager();
        $repo = $em->getRepository(\App\CoreBundle\Entity\Career::class);
        $promotion
