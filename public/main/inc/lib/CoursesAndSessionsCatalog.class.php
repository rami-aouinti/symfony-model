...
class CoursesAndSessionsCatalog
{
    ...
    public static function getFormattedSessionsBlock(array $sessions)
    {
        ...
        $tagRepo = \App\CoreBundle\Framework\Container::getTagRepository();

        $tagsField = $extraFieldRepo->findOneBy([
            'itemType' => App\Platform\Domain\Entity\ExtraField::COURSE_FIELD_TYPE,
            'variable' => 'tags',
        ]);

        /** @var \App\Session\Domain\Entity\Session $session */
