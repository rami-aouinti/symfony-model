...
$skillRelSkill = $entityManager->getRepository(\App\CoreBundle\Entity\Skill\SkillRelSkill::class);
$skillLevelRepo = $entityManager->getRepository(\App\CoreBundle\Entity\Level::class);
$skillUserRepo = $entityManager->getRepository(\App\CoreBundle\Entity\Skill\SkillRelUser::class);
