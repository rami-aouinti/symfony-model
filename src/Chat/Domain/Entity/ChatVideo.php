 ...
 * Chat.
 */
#[ORM\Table(name: 'chat_video', options: [
    'row_format' => 'DYNAMIC',
])]
#[ORM\Index(columns: ['to_user'], name: 'idx_chat_video_to_user')]
#[ORM\Index(columns: ['from_user'], name: 'idx_chat_video_from_user')]
#[ORM\Index(columns: ['from_user', 'to_user'], name: 'idx_chat_video_users')]
#[ORM\Index(columns: ['title'], name: 'idx_chat_video_title')]
#[ORM\Entity]
class ChatVideo
{
