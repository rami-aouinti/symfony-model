...
namespace App\CourseBundle\Component\CourseCopy;

use App\CourseBundle\Component\CourseCopy\Resources\Announcement;
use App\CourseBundle\Component\CourseCopy\Resources\Attendance;
use App\CourseBundle\Component\CourseCopy\Resources\CalendarEvent;
use App\CourseBundle\Component\CourseCopy\Resources\CourseCopyLearnpath;
use App\CourseBundle\Component\CourseCopy\Resources\CourseCopyTestCategory;
use App\CourseBundle\Component\CourseCopy\Resources\CourseDescription;
use App\CourseBundle\Component\CourseCopy\Resources\CourseSession;
use App\CourseBundle\Component\CourseCopy\Resources\Document;
use App\CourseBundle\Component\CourseCopy\Resources\Forum;
use App\CourseBundle\Component\CourseCopy\Resources\ForumCategory;
use App\CourseBundle\Component\CourseCopy\Resources\ForumPost;
use App\CourseBundle\Component\CourseCopy\Resources\ForumTopic;
use App\CourseBundle\Component\CourseCopy\Resources\Glossary;
use App\CourseBundle\Component\CourseCopy\Resources\GradeBookBackup;
use App\CourseBundle\Component\CourseCopy\Resources\LearnPathCategory;
use App\CourseBundle\Component\CourseCopy\Resources\Link;
use App\CourseBundle\Component\CourseCopy\Resources\LinkCategory;
use App\CourseBundle\Component\CourseCopy\Resources\Quiz;
use App\CourseBundle\Component\CourseCopy\Resources\QuizQuestion;
use App\CourseBundle\Component\CourseCopy\Resources\QuizQuestionOption;
use App\CourseBundle\Component\CourseCopy\Resources\ScormDocument;
use App\CourseBundle\Component\CourseCopy\Resources\Survey;
use App\CourseBundle\Component\CourseCopy\Resources\SurveyQuestion;
use App\CourseBundle\Component\CourseCopy\Resources\Thematic;
use App\CourseBundle\Component\CourseCopy\Resources\ToolIntro;
use App\CourseBundle\Component\CourseCopy\Resources\Wiki;
use App\CourseBundle\Component\CourseCopy\Resources\Work;
        ...
        if ($addScormFolder) {
            ...
            if ($dir = @opendir($this->course->backup_path . '/scorm')) {
                while ($file = readdir($dir)) {
                    if (
                        is_dir($this->course->backup_path . '/scorm/' . $file) &&
                        !in_array($file, ['.', '..'])
                    ) {
