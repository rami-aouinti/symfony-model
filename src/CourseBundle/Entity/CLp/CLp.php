...
class CLp extends AbstractResource implements ResourceInterface, ResourceShowCourseResourcesInSessionInterface, Stringable
{
    ...
    #[ORM\Column(name: 'default_view_mod', type: 'string', length: 32, nullable: false, options: [
        'default' => 'embedded',
    ])]
    protected string $defaultViewMod;

    #[ORM\Column(name: 'default_encoding', type: 'string', length: 32, nullable: false, options: [
        'default' => 'UTF-8',
    ])]
    ...
    #[ORM\Column(name: 'content_local', type: 'string', length: 32, nullable: false, options: [
        'default' => 'local',
    ])]
    ...
    #[ORM\Column(name: 'prevent_reinit', type: 'boolean', nullable: false, options: [
        'default' => 1,
    ])]
    ...
    #[ORM\Column(name: 'use_max_score', type: 'integer', nullable: false, options: [
        'default' => 1,
    ])]
    ...
    #[ORM\Column(name: 'accumulate_scorm_time', type: 'integer', nullable: false, options: [
        'default' => 1,
    ])]
    protected int $accumulateScormTime = 1;

    #[ORM\Column(name: 'accumulate_work_time', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    protected int $accumulateWorkTime = 0;

    #[ORM\Column(name: 'next_lp_id', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    protected int $nextLpId = 0;

    #[ORM\Column(name: 'subscribe_user_by_date', type: 'boolean', nullable: false, options: [
        'default' => 0,
    ])]
    protected bool $subscribeUserByDate = false;

    #[ORM\Column(name: 'display_not_allowed_lp', type: 'boolean', nullable: true, options: [
        'default' => 0,
    ])]
