...
use App\CoreBundle\State\CStudentPublicationPostStateProcessor;
...
class CStudentPublication extends AbstractResource implements ResourceInterface, Stringable
{
    ...
    #[ORM\Column(name: 'student_delete_own_publication', type: 'boolean', nullable: true, options: [
        'default' => 0,
    ])]
    protected ?bool $studentDeleteOwnPublication = null;

    #[ORM\Column(name: 'default_visibility', type: 'boolean', nullable: true, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'group_category_work_id', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    #[Groups(['c_student_publication:write', 'student_publication:read'])]
    ...
    public function getCorrection(): ?ResourceNode
    {
        if ($this->hasResourceNode()) {
            ...
            foreach ($children as $child) {
                ...
                if ($name === 'student_publications_corrections') {
                    return $child;
                }
            }
        }
