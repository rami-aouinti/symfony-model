...
class CGroupCategory extends AbstractResource implements ResourceInterface, Stringable
{
    ...
    #[ORM\Column(name: 'document_access', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'only_me', type: 'boolean', options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'allow_coach_change_options_groups', type: 'boolean', options: [
        'default' => 0,
    ])]
    protected bool $allowCoachChangeOptionsGroups = false;

    #[ORM\Column(name: 'allow_change_group_name', type: 'integer', nullable: true, options: [
        'default' => 1,
    ])]
    protected ?int $allowChangeGroupName = 1;

    #[ORM\Column(name: 'allow_autogroup', type: 'boolean', options: [
        'default' => 0,
    ])]
