...
class CQuiz extends AbstractResource implements ResourceInterface, ResourceShowCourseResourcesInSessionInterface, Stringable
{
    ...
    #[ORM\Column(name: 'prevent_backwards', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'hide_question_number', type: 'integer', nullable: false, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'show_previous_button', type: 'boolean', nullable: false, options: [
        'default' => 1,
    ])]
    ...
    #[ORM\Column(name: 'autolaunch', type: 'boolean', nullable: true, options: [
        'default' => 0,
    ])]
    protected ?bool $autoLaunch;

    #[ORM\Column(name: 'hide_attempts_table', type: 'boolean', nullable: false, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'display_chart_degree_certainty', type: 'integer', options: [
        'default' => 0,
    ])]
    protected int $displayChartDegreeCertainty = 0;

    #[ORM\Column(name: 'send_email_chart_degree_certainty', type: 'integer', options: [
        'default' => 0,
    ])]
    protected int $sendEmailChartDegreeCertainty = 0;

    #[ORM\Column(name: 'not_display_balance_percentage_categorie_question', type: 'integer', options: [
        'default' => 0,
    ])]
    protected int $notDisplayBalancePercentageCategorieQuestion = 0;

    #[ORM\Column(name: 'display_chart_degree_certainty_category', type: 'integer', options: [
        'default' => 0,
    ])]
    protected int $displayChartDegreeCertaintyCategory = 0;

    #[ORM\Column(name: 'gather_questions_categories', type: 'integer', options: [
        'default' => 0,
    ])]
