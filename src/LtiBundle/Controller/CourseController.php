...
use App\CoreBundle\Component\Utils\ToolIcon;
...
class CourseController extends ToolBaseController
{
    ...
    #[Route(path: '/edit/{id}', name: 'chamilo_lti_edit', requirements: [
        'id' => '\d+',
    ])]
    ...
    #[Route(path: '/launch/{id}', name: 'chamilo_lti_launch', requirements: [
        'id' => '\d+',
    ])]
    ...
    #[Route(path: '/{id}', name: 'chamilo_lti_show', requirements: [
        'id' => '\d+',
    ])]
    ...
    #[Route(path: '/add/{id}', name: 'chamilo_lti_configure_global', requirements: [
        'id' => '\d+',
    ])]
     ...
     * @throws Exception
     */
    #[Route(path: '/grade/{catId}', name: 'chamilo_lti_grade', requirements: [
        'catId' => '\d+',
    ])]
