...
namespace App\LtiBundle\Entity;
...
class ExternalTool extends AbstractResource implements ResourceInterface, ResourceToRootInterface, Stringable
{
    ...
    #[ORM\Column(name: 'active_deep_linking', type: 'boolean', nullable: false, options: [
        'default' => false,
    ])]
    protected bool $activeDeepLinking;

    #[ORM\Column(name: 'privacy', type: 'text', nullable: true, options: [
        'default' => null,
    ])]
    ...
    #[ORM\Column(name: 'version', type: 'string', options: [
        'default' => 'lti1p1',
    ])]
