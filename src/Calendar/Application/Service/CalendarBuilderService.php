...
{
    final public const int BIRTHDAY_YEAR_NOT_GIVEN = 2100;

    final public const int ALIGN_LEFT = 1;

    final public const int ALIGN_CENTER = 2;

    final public const int ALIGN_RIGHT = 3;

    final public const int VALIGN_TOP = 1;

    final public const int VALIGN_BOTTOM = 2;

    final public const int ZOOM_HEIGHT_100 = 4000;

    final public const int DAY_SUNDAY = 0;

    final public const int DAY_MONDAY = 1;

    final public const string IMAGE_PNG = 'png';

    final public const string IMAGE_JPG = 'jpg';

    final public const int EVENT_TYPE_BIRTHDAY = 0;

    final public const int EVENT_TYPE_EVENT = 1;

    final public const int EVENT_TYPE_EVENT_GROUP = 2;

    final public const int DEFAULT_QR_CODE_VERSION = 5;
    ...
    /**
     * @var array<string, array{x: int, y: int, align: int, dimension: int[], day: int}>
     */
    ...
    protected function addEvents(): void
    {
        ...
        foreach ($this->calendarImage->getUser()->getEvents() as $event) {
            ...
            if ($event->getType() !== self::EVENT_TYPE_BIRTHDAY) {
