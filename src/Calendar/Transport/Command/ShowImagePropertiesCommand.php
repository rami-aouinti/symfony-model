...
use App\Media\Application\Utils\Image\Color;
use App\Media\Application\Utils\Image\ColorDetectorCiede2000;
use App\Media\Application\Utils\Image\ColorDetectorSimple;
use App\Media\Application\Utils\Image\Palette;
...
class ShowImagePropertiesCommand extends Command
{
    ...
    protected const string NAME_TRANSPARENT = 'transparent';

    protected const int DEFAULT_IMAGE_WIDTH = 120;

    protected const int DEFAULT_COLOR_COUNT = 5;

    /* @see https://www.php.net/manual/de/function.imagesetinterpolation.php */
    protected const int DEFAULT_IMAGE_MODE = IMG_GAUSSIAN;
