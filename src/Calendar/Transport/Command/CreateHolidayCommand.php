...
{
    final public const string API_DATE_FORMAT = 'Y-m-d';

    final public const int YEARLY_YEAR = 1970;

    protected const string API_ENDPOINT = 'https://feiertage-api.de/api/?jahr=%d';

    protected const string API_DATE_FIELD = 'datum';

    protected const array YEARLY_DATES = [
