...
use App\CoreBundle\Controller\Api\UpdateCCalendarEventAction;
...
use App\CoreBundle\Filter\GlobalEventFilter;
use App\CoreBundle\Filter\SidFilter;
use App\CoreBundle\State\CalendarEventStateProvider;
use App\CoreBundle\State\CCalendarEventStateProcessor;
...
class CCalendarEvent extends AbstractResource implements ResourceInterface, Stringable
{
    ...
    public function determineType(): string
    {
        ...
        foreach ($resourceLinks as $link) {
            ...
            if ($link->getCourse() !== null) {
                return 'course';
            }

            if ($link->getSession() !== null) {
                return 'session';
            }
        }
