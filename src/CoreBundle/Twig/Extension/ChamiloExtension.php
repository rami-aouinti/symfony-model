...
use App\CoreBundle\Twig\SettingsHelper;
...
class ChamiloExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('password_checker_js', [$this, 'getPasswordCheckerJs'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('theme_asset', $this->getThemeAssetUrl(...)),
            new TwigFunction('theme_asset_link_tag', $this->getThemeAssetLinkTag(...), [
                'is_safe' => ['html'],
            ]),
     ...
     * @return mixed|string
     */
    public function getSettingsParameter($name): mixed
    {
