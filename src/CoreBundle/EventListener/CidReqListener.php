...
use App\CoreBundle\Controller\EditorController;
use App\CoreBundle\Entity\Course\Course;
use App\CoreBundle\Entity\User\User;
use App\CoreBundle\Exception\NotAllowedException;
use App\CoreBundle\Security\Authorization\Voter\CourseVoter;
use App\CoreBundle\Security\Authorization\Voter\GroupVoter;
use App\CoreBundle\Security\Authorization\Voter\SessionVoter;
...
class CidReqListener
{
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        if (!empty($courseId)) {
            ...
            if ($checker->isGranted(CourseVoter::VIEW, $course) === false) {
            ...
            if (empty($sessionId)) {
                ...
                if ($session !== null) {
                    ...
                    if ($checker->isGranted(SessionVoter::VIEW, $session) === false) {
            ...
            if (empty($groupId)) {
                ...
                if ($checker->isGranted(GroupVoter::VIEW, $group) === false) {
