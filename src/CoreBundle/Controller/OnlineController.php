...
{
    #[Route(path: '/', name: 'users_online', methods: ['GET'], options: [
        'expose' => true,
    ])]
    ...
    #[Route(path: '/in_course/{cidReq}', name: 'online_users_in_course', methods: ['GET', 'POST'], options: [
        'expose' => true,
    ])]
    ...
    #[Route(path: '/in_sessions', name: 'online_users_in_session', methods: ['GET', 'POST'], options: [
        'expose' => true,
    ])]
