...
class IndexBlocksController extends BaseController
{
    ...
    public function __invoke(): JsonResponse
    {
        ...
        $json['users'] = [
            ...
            'searchUrl' => $this->generateUrl('legacy_main', [
        ...
        if ($this->isAdmin) {
            ...
            // Skills
            if ($this->settingsManager->getSetting('skill.allow_skills_tool') === 'true') {
                $json['skills'] = [
            ...
            if ($this->settingsManager->getSetting('gradebook.gradebook_dependency') === 'true') {
                $json['gradebook'] = [
            ...
            // Data protection
            if ($this->settingsManager->getSetting('profile.disable_gdpr') !== 'true') {
                $json['data_privacy'] = [
    ...
    private function getItemsUsers(): array
    {
        ...
        if ($this->isAdmin) {
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/user_update_import.php',
                ]),
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/user_anonymize_import.php',
                ]),
            ...
            if (\count($this->extAuthSource['extldap']) > 0) {
                $items[] = [
                    ...
                    'url' => $this->generateUrl('legacy_main', [
                        'name' => 'admin/ldap_users_list.php',
                    ]),
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/usergroups.php',
                ]),
                'label' => $this->translator->trans('Classes'),
            ];

            if ($this->settingsManager->getSetting('admin.show_link_request_hrm_user') === 'true') {
                $items[] = [
                    'class' => 'item-user-linking-requests',
                    'url' => $this->generateUrl('legacy_main', [
                        'name' => 'admin/user_linking_requests.php',
                    ]),
            ...
            if ($this->settingsManager->getSetting('session.limit_session_admin_role') === 'true') {
                $items = array_filter($items, function (array $item) {
                    $urls = [
                        $this->generateUrl('legacy_main', [
                            'name' => 'admin/user_list.php',
                        ]),
                        $this->generateUrl('legacy_main', [
                            'name' => 'admin/user_add.php',
            ...
            if ($this->settingsManager->getSetting('session.limit_session_admin_list_users') === 'true') {
            ...
            if ($this->settingsManager->getSetting('session.allow_session_admin_extra_access') === 'true') {
                $items[] = [
                    'class' => 'item-user-import-update',
                    'url' => $this->generateUrl('legacy_main', [
                        'name' => 'admin/user_update_import.php',
    ...
    private function getExtraContent(string $title): ?array
    {
        ...
        $pageJsonld = $this->serializer->serialize($page, 'jsonld', [
            'groups' => ['adminblock:read'],
        ]);
        ...
        $category = $this->pageCategoryRepository->findOneBy([
            'title' => $title,
        ]);
        $categoryJsonld = $this->serializer->serialize($category, 'jsonld', [
            'groups' => ['page:read'],
        ]);
    ...
    private function getItemsCourses(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/course_add.php',
            ]),
            'label' => $this->translator->trans('Add course'),
        ];

        if ($this->settingsManager->getSetting('course.course_validation') === 'true') {
            $items[] = [
                'class' => 'item-course-request',
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/course_request_review.php',
                ]),
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/course_request_accepted.php',
                ]),
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/course_request_rejected.php',
                ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/course_category.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/subscribe_user2course.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/course_user_import.php',
            ]),
            'label' => $this->translator->trans('Import users list'),
        ];
        // $items[] = [
        ...
        if ($this->settingsManager->getSetting('gradebook.gradebook_enable_grade_model') === 'true') {
            $items[] = [
                'class' => 'item-grade-model',
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/grade_models.php',
                ]),
        ...
        if (\count($this->extAuthSource['ldap']) > 0) {
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/ldap_import_students.php',
                ]),
    ...
    private function getItemsPlatform(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/system_announcements.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/import_course_agenda_reminders.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/configure_inscription.php',
            ]),
        ...
        $items[] = [
            'class' => 'item-stats',
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/statistics/index.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'mySpace/company_reports.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/teacher_time_report.php',
            ]),
        ...
        $items[] = [
            'class' => 'item-field',
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/extra_field_list.php',
            ]),
        ...
        if ($this->settingsManager->getSetting('registration.allow_terms_conditions') === 'true') {
            $items[] = [
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'mail_template/list.php',
            ]),
            'label' => $this->translator->trans('Mail templates'),
        ];

        if (api_get_setting('platform.notification_event') === 'true') {
            $items[] = [
                'class' => 'item-notification-list',
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'notification_event/list.php',
                ]),
    ...
    private function getItemsSettings(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/archive_cleanup.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/special_exports.php',
            ]),
    ...
    private function getItemsSkills(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'social/skills_ranking.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'skills/skills_gradebook.php',
            ]),
    ...
    private function getItemsPrivacy(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'admin/user_list_consent.php',
            ]),
            'label' => $this->translator->trans('User list'),
        ];
    ...
    private function getItemsChamilo(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => '../documentation/installation_guide.html',
            ]),
        ...
        $items[] = [
            'class' => 'item-credits',
            'url' => $this->generateUrl('legacy_main', [
                'name' => '../documentation/credits.html',
            ]),
        ...
        $items[] = [
            'class' => 'item-security',
            'url' => $this->generateUrl('legacy_main', [
                'name' => '../documentation/security.html',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => '../documentation/optimization.html',
            ]),
    ...
    private function getItemsSessions(): array
    {
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'session/session_category_list.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'session/session_import.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'session/session_import_drh.php',
            ]),
        ...
        if (\count($this->extAuthSource['ldap']) > 0) {
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/ldap_import_students_to_session.php',
                ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'session/session_export.php',
            ]),
        ...
        $items[] = [
            ...
            'url' => $this->generateUrl('legacy_main', [
                'name' => 'coursecopy/copy_course_session.php',
            ]),
        ...
        if ($this->isAdmin || ($allowCareer === 'true' && $this->isSessionAdmin)) {
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/career_dashboard.php',
                ]),
            ...
            $items[] = [
                ...
                'url' => $this->generateUrl('legacy_main', [
                    'name' => 'admin/export_exercise_results.php',
                ]),
