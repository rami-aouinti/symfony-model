...
class IndexController extends BaseController
{
    ...
    #[Route('/home', name: 'home', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    #[Route('/login', name: 'login', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    #[Route('/faq', name: 'faq', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    #[Route('/demo', name: 'demo', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    #[Route('/course/{cid}/home', name: 'chamilo_core_course_home')]
    #[Route('/courses', name: 'courses', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    #[Route('/catalogue/{slug}', name: 'catalogue', options: [
        'expose' => true,
    ], methods: ['GET', 'POST'])]
    ...
    #[Route('/account/home', name: 'chamilo_core_account_home', options: [
        'expose' => true,
    ])]
    #[Route('/social', name: 'chamilo_core_socialnetwork', options: [
        'expose' => true,
    ])]
    ...
    {
        return $this->render('@ChamiloCore/Layout/no_layout.html.twig', [
            'content' => '',
        ]);
    }
    ...
    public function toggleStudentView(Request $request, SettingsManager $settingsManager): Response
    {
        ...
        if ($settingsManager->getSetting('course.student_view_enabled') !== 'true') {
            throw $this->createAccessDeniedException();
        }
