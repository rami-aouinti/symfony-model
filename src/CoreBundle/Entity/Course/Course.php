...
namespace App\CoreBundle\Entity\Course;
...
use App\CoreBundle\Entity\Listener\CourseListener;
use App\CoreBundle\Entity\Listener\ResourceListener;
use App\CoreBundle\Entity\Skill\SkillRelCourse;
...
use App\Platform\Domain\Entity\Room;
use App\Platform\Domain\Entity\SearchEngineRef;
...
use App\Track\Domain\Entity\TrackCourseRanking;
...
class Course extends AbstractResource implements ResourceInterface, ResourceWithAccessUrlInterface, ResourceIllustrationInterface, ExtraFieldItemInterface, Stringable
{
    ...
    /**
     * ORM\OneToMany(targetEntity="App\CoreBundle\Entity\SpecificFieldValues", mappedBy="course").
     */
    // protected $specificFieldValues;

    /**
     * ORM\OneToMany(targetEntity="App\CoreBundle\Entity\SharedSurvey", mappedBy="course").
     */
    ...
    {
        return $this->visibility === self::HIDDEN;
    }
