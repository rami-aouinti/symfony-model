...
class GradebookCategory
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, cascade: ['persist'], inversedBy: 'gradeBookCategories')]
    ...
    #[ORM\Column(name: 'is_requirement', type: 'boolean', nullable: false, options: [
        'default' => 0,
    ])]
    ...
    #[ORM\Column(name: 'allow_skills_by_subcategory', type: 'integer', nullable: true, options: [
        'default' => 1,
    ])]
