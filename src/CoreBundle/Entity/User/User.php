...
use App\CoreBundle\Entity\Gradebook\GradebookComment;
use App\CoreBundle\Entity\Gradebook\GradebookLinkevalLog;
use App\CoreBundle\Entity\Gradebook\GradebookResult;
use App\CoreBundle\Entity\Gradebook\GradebookResultLog;
use App\CoreBundle\Entity\Gradebook\GradebookScoreLog;
use App\CoreBundle\Entity\Group;
use App\CoreBundle\Entity\Listener\UserListener;
...
use App\CoreBundle\Filter\SearchOrFilter;
use App\CoreBundle\Repository\Node\UserRepository;
use App\CoreBundle\Traits\UserCreatorTrait;
use App\CourseBundle\Entity\Group\CGroupRelTutor;
...
use App\Platform\Domain\Entity\ExtraFieldItemInterface;
...
use App\Sequence\Domain\Entity\SequenceValue;
use App\Session\Domain\Entity\Session;
use App\Session\Domain\Entity\SessionRelCourseRelUser;
use App\Session\Domain\Entity\SessionRelUser;
use App\Track\Domain\Entity\TrackEAccessComplete;
use App\Track\Domain\Entity\TrackEAttempt;
use App\Track\Domain\Entity\TrackECourseAccess;
use App\Track\Domain\Entity\TrackEExerciseConfirmation;
...
class User implements UserInterface, EquatableInterface, ResourceInterface, ResourceIllustrationInterface, PasswordAuthenticatedUserInterface, LegacyPasswordAuthenticatedUserInterface, ExtraFieldItemInterface, Stringable
{
    ...
    /**
     * ORM\OneToMany(targetEntity="App\CourseBundle\Entity\CDropboxPost", mappedBy="user").
     */
    protected Collection $dropBoxReceivedFiles;

    /**
     * ORM\OneToMany(targetEntity="App\CourseBundle\Entity\CDropboxFile", mappedBy="userSent").
     */
    ...
    /**
     * ORM\OneToMany(targetEntity="App\CoreBundle\Entity\JuryMembers", mappedBy="user").
     */
    ...
    /**
     * ORM\OneToMany(targetEntity="App\CoreBundle\Entity\CurriculumItemRelUser", mappedBy="user").
     */
