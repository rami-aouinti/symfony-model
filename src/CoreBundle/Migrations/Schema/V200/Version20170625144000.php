...
class Version20170625144000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        ...
        if ($table->hasForeignKey('FK_25687EB838B217A7') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('UNIQ_25687EB838B217A7') === false) {
            $this->addSql(
                'ALTER TABLE c_student_publication_assignment ADD UNIQUE INDEX UNIQ_25687EB838B217A7 (publication_id)'
            );
        }

        if ($schema->hasTable('c_student_publication_correction') === false) {
            $this->addSql(
