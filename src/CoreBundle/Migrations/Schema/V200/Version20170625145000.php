...
class Version20170625145000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasForeignKey('FK_86FD1CA87300D633') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_86FD1CA87300D633') === false) {
        ...
        if ($table->hasForeignKey('FK_7D4436947300D633') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_7D4436947300D633') === false) {
