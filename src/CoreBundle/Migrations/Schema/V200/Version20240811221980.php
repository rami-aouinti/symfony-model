...
final class Version20240811221980 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasIndex('UNIQ_DB0E04E41BAD783F') === false) {
        ...
        if ($table->hasIndex('IDX_DB0E04E491D79BD3') === false) {
        ...
        if ($table->hasIndex('IDX_DB0E04E482F80D8B') === false) {
        ...
        if ($table->hasIndex('IDX_DB0E04E4727ACA70') === false) {
