...
class Version20181025064351 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasForeignKey('FK_C5C4CABBA76ED395') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_C5C4CABBA76ED395') === false) {
        ...
        if ($table->hasForeignKey('FK_96A4C705727ACA70') === false) {
        ...
        if ($table->hasForeignKey('FK_96A4C705613FECDF') === false) {
        ...
        if ($table->hasForeignKey('FK_96A4C705A76ED395') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_96A4C705A76ED395') === false) {
        ...
        if ($table->hasIndex('idx_ge_cat') === false) {
        ...
        if ($table->hasForeignKey('FK_DDDED804A76ED395') === false) {
        ...
        if ($table->hasIndex('IDX_DDDED804A76ED395') === false) {
        ...
        if ($table->hasIndex('idx_gl_cat') === false) {
        ...
        if ($table->hasForeignKey('FK_4F0F595FA76ED395') === false) {
        ...
        if ($table->hasIndex('IDX_4F0F595FA76ED395') === false) {
        ...
        if ($table->hasForeignKey('FK_4F0F595F12469DE2') === false) {
        ...
        if ($table->hasIndex('idx_gb_uid_eid') === false) {
        ...
        if ($table->hasForeignKey('FK_650669DE6ADA943') === false) {
        ...
        if ($table->hasColumn('downloaded_at') === false) {
        ...
        if ($table->hasForeignKey('FK_650669DA76ED395') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_650669DE6ADA943') === false) {
            $this->addSql('CREATE INDEX IDX_650669DE6ADA943 ON gradebook_certificate (cat_id);');
        }

        if ($schema->hasTable('gradebook_result_attempt') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_1F554C7474C99BA2') === false) {
        }
        ...
        if ($table->hasIndex('IDX_1F554C7474C99BA2') === false) {
        ...
        if ($table->hasForeignKey('FK_640C6449A76ED395') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_640C644912469DE2') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_640C644912469DE2') === false) {
        ...
        if ($table->hasForeignKey('FK_61F7DC8412469DE2') === false) {
