...
class Version20180927172830 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasForeignKey('FK_B5BEF559E2904019') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_B5BEF5595BB66C05') === false) {
        ...
        if ($table->hasIndex('IDX_47A9C9921BF9426') === false) {
            $this->addSql('CREATE INDEX IDX_47A9C9921BF9426 ON c_forum_forum (forum_category)');
        }

        if ($table->hasForeignKey('FK_47A9C99F2E82C87') === false) {
        ...
        if ($table->hasForeignKey('FK_5DA7884C29CCBAD0') === false) {
        ...
        if ($table->hasForeignKey('FK_5DA7884C43CB876D') === false) {
        ...
        if ($table->hasForeignKey('FK_5DA7884CD4DC43B9') === false) {
