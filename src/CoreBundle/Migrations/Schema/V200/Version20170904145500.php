...
class Version20170904145500 extends AbstractMigrationChamilo
{
    ...
    {
        if ($schema->hasTable('c_exercise_category') === false) {
            $this->addSql(
        ...
        if ($table->hasColumn('exercise_category_id')) {
            ...
            if ($table->hasForeignKey('FK_B7A1C35FB48D66') === false) {
                $this->addSql(
        ...
        if ($table->hasIndex('IDX_B7A1C35FB48D66') === false) {
        ...
        if ($table->hasColumn('prevent_backwards') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_AEBC3EFF1E27F6BF') === false) {
        ...
        if ($table->hasColumn('mandatory') === false) {
        ...
        if ($table->hasColumn('feedback') === false) {
        ...
        if ($table->hasForeignKey('FK_485736AC1E27F6BF') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_A468585C12469DE2') === false) {
        ...
        if ($table->hasIndex('IDX_A468585C1E27F6BF') === false) {
