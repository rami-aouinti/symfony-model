...
class Version20170625123000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasColumn('resource_node_id') === false) {
        ...
        if ($table->hasForeignKey('FK_AA3A9AB8163DDA15') === false) {
        ...
        if ($table->hasIndex('IDX_AA3A9AB8163DDA15') === false) {
        ...
        if ($table->hasIndex('IDX_2C7640A76ED395') === false) {
            $this->addSql('CREATE INDEX IDX_2C7640A76ED395 ON c_attendance_result (user_id);');
        }

        if ($table->hasIndex('IDX_2C7640163DDA15') === false) {
        ...
        if ($table->hasForeignKey('FK_C2AB1FACFE54D947') === false) {
        ...
        if ($table->hasForeignKey('FK_C2AB1FACA40A2C8') === false) {
