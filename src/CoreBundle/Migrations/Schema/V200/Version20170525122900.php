...
class Version20170525122900 extends AbstractMigrationChamilo
{
    ...
    {
        if ($schema->hasTable('resource_node') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_file') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_tag') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_user_tag') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('personal_file') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_link') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('tool_resource_right') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_right') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('resource_type') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('illustration') === false) {
            $this->addSql(
        ...
        if ($schema->hasTable('c_shortcut') === false) {
            $this->addSql(
