...
class Version20170628122900 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasColumn('limit_courses') === false) {
            $this->addSql(
        ...
        if ($table->hasColumn('parent_id') === false) {
        ...
        if ($table->hasColumn('tree_root') === false) {
        ...
        if ($table->hasForeignKey('FK_3545C2A673444FD5') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_3545C2A66628AD36') === false) {
            $this->addSql(
