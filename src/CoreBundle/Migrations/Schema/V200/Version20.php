...
use App\CoreBundle\DataFixtures\LanguageFixtures;
...
class Version20 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($schema->hasTable('asset') === false) {
        ...
        if ($table->hasForeignKey('FK_33548A73A76ED395') === false) {
            $this->addSql(
        ...
        if ($table->hasForeignKey('FK_F62F45ED73444FD5') === false) {
        ...
        if ($table->hasIndex('IDX_F62F45ED73444FD5') === false) {
        ...
        if ($table->hasForeignKey('FK_D86124608D93D649') === false) {
        ...
        if ($table->hasColumn('author_id') === false) {
        ...
        if ($table->hasIndex('IDX_6F287D8EA76ED395') === false) {
            $this->addSql('CREATE INDEX IDX_6F287D8EA76ED395 ON templates (user_id)');
        }
        if ($table->hasForeignKey('FK_6F287D8EA76ED395') === false) {
