...
class Version20170625143000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($table->hasIndex('IDX_62798E972395FCED') === false) {
        ...
        if ($table->hasForeignKey('FK_62798E972395FCED') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_62798E97163DDA15') === false) {
        ...
        if ($table->hasForeignKey('FK_1197487C2395FCED') === false) {
            $this->addSql(
        ...
        if ($table->hasIndex('IDX_1197487C2395FCED') === false) {
        ...
        if ($table->hasForeignKey('FK_9209C2A012469DE2') === false) {
            $this->addSql(
