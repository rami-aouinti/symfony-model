...
final class Version20201216132000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $q = $this->entityManager->createQuery('SELECT lp FROM App\CourseBundle\Entity\CLp lp WHERE lp.iid = 263 ORDER BY lp.iid');
        $q = $this->entityManager->createQuery('SELECT lp FROM App\CourseBundle\Entity\CLp lp');
        $counter = 1;
