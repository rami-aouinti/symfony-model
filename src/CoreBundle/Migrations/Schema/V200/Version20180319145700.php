...
class Version20180319145700 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($survey->hasColumn('is_mandatory') === false) {
        ...
        if ($survey->hasColumn('resource_node_id') === false) {
        ...
        if ($table->hasForeignKey('FK_C4B6F5F1E27F6BF') === false) {
        ...
        if ($table->hasForeignKey('FK_C4B6F5FB3FE509D') === false) {
        ...
        if ($table->hasIndex('IDX_C4B6F5FB3FE509D') === false) {
