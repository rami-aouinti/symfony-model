...
use App\CourseBundle\Component\CourseCopy\CourseBuilder;
use App\CourseBundle\Component\CourseCopy\CourseRestorer;
...
class CourseService
{
    ...
    public function fillCourse(Course $course, array $params): void
    {
        ...
        if ($this->settingsManager->getSetting('course.example_material_course_creation') === 'true') {
    ...
    public function useTemplateAsBasisIfRequired($courseCode, $courseTemplate): void
    {
        ...
        $teacherCanSelectCourseTemplate = $this->settingsManager->getSetting('course.teacher_can_select_course_template') === 'true';
    ...
    private function insertCourseSettings(Course $course): void
    {
        ...
        if ($this->settingsManager->getSetting('exercise.email_alert_manager_on_new_quiz') === 'true') {
        ...
        $settings = [
            ...
            'email_alert_manager_on_new_quiz' => [
                'default' => $defaultEmailExerciseAlert,
                'category' => 'quiz',
            ],
            ...
            'allow_public_certificates' => [
                'default' => $this->settingsManager->getSetting('course.allow_public_certificates') === 'true' ? 1 : '',
    ...
    private function insertExampleContent(Course $course, GradebookCategory $gradebook): void
    {
        ...
        $files = [
            [
                'path' => '/audio',
                'title' => $this->translator->trans('Audio'),
                'filetype' => 'folder',
                'size' => 0,
            ],
            [
                'path' => '/images',
                'title' => $this->translator->trans('Images'),
                'filetype' => 'folder',
                'size' => 0,
            ],
            [
            ...
            [
                'path' => '/video',
                'title' => $this->translator->trans('Video'),
                'filetype' => 'folder',
                'size' => 0,
            ],
        ];
        ...
        foreach ($finder as $file) {
            ...
            if ($parentName === '/' || $parentName === '/certificates') {
                continue;
            }
        ...
        $params = [
            ...
            'forum_comment' => '',
            'default_view_type_group' => [
                'default_view_type' => 'flat',
            ],
        ];
