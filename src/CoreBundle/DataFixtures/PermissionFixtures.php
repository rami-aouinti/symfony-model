...
class PermissionFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($permissions as $permData) {
            $existingPermission = $manager->getRepository(Permission::class)->findOneBy([
                'slug' => $permData['slug'],
            ]);
    ...
    public static function getPermissions(): array
    {
        return [
            ...
            [
                'title' => 'View assigned analytics',
                'slug' => 'analytics:viewassigned',
                'description' => 'View results of users assigned to me',
            ],
            [
                'title' => 'View all analytics',
                'slug' => 'analytics:viewall',
            ...
            [
                'title' => 'Copy backup',
                'slug' => 'backup:copy',
                'description' => 'Copy course content to another course',
            ],
            [
            ...
            [
                'title' => 'Configure badge criteria',
                'slug' => 'badge:configurecriteria',
                'description' => 'Configure badge criteria',
            ],
            [
                'title' => 'Create badge',
                'slug' => 'badge:create',
            ...
            [
                'title' => 'View courses catalogue',
                'slug' => 'catalogue:view',
                'description' => 'View courses catalogue',
            ],
            [
                'title' => 'Create certificate template',
                'slug' => 'certificate:create',
                'description' => 'Create certificate templates',
            ],
            [
                'title' => 'Delete certificate template',
                'slug' => 'certificate:delete',
                'description' => 'Delete certificate templates',
            ],
            [
                'title' => 'Edit certificate template',
                'slug' => 'certificate:edit',
                'description' => 'Edit certificate templates',
            ],
            [
                'title' => 'Generate certificate',
                'slug' => 'certificate:generate',
                'description' => 'Generate certificates',
            ],
            [
                'title' => 'Generate all certificates',
                'slug' => 'certificate:generateall',
                'description' => 'Generate all certificates in a gradebook',
            ],
            [
                'title' => 'View all certificates',
                'slug' => 'certificate:viewall',
                'description' => 'View all instances of one certificate issued to all users',
            ],
            [
                'title' => 'Assign course to class',
                'slug' => 'class:assigncourse',
                'description' => 'Assign a class to a course',
            ],
            [
                'title' => 'Assign cession to class',
                'slug' => 'class:assignsession',
                'description' => 'Assign a class to a session',
            ],
            [
                'title' => 'Assign user to class',
                'slug' => 'class:assignuser',
                'description' => 'Assign a user to a class',
            ],
            [
                'title' => 'Create class',
                'slug' => 'class:create',
                'description' => 'Create global classes of users',
            ],
            [
                'title' => 'Delete class',
                'slug' => 'class:delete',
                'description' => 'Delete global classes',
            ],
            [
                'title' => 'Edit class',
                'slug' => 'class:edit',
                'description' => 'Edit global classes',
            ],
            [
                'title' => 'View class',
                'slug' => 'class:view',
                'description' => 'View global classes details',
            ],
            [
            ...
            [
                ...
                'slug' => 'course:downloadcoursecontent',
                'description' => 'Download all course content',
            ],
            [
                'title' => 'Edit own course properties',
                'slug' => 'course:edit',
                'description' => 'Edit own course\'s properties',
            ],
            [
                'title' => 'Edit all course properties',
                'slug' => 'course:editall',
                'description' => 'Edit all course\'s properties',
            ],
            [
                'title' => 'Manage plugins',
                'slug' => 'plugin:manage',
                'description' => 'Enable/disable/configure plugins',
            ],
            [
                'title' => 'Create quiz',
                'slug' => 'quiz:create',
            ...
            [
                'title' => 'View live quiz results',
                'slug' => 'quiz:viewliveresults',
                'description' => 'View live quiz results',
            ],
            [
                'title' => 'Manage question bank',
                'slug' => 'quiz:managequestionbank',
            ...
            [
                ...
                'slug' => 'session:edit',
                'description' => 'Edit properties of user\'s own sessions',
            ],
            [
                'title' => 'Edit all session properties',
                'slug' => 'session:editall',
                'description' => 'Edit properties of all sessions',
            ],
            [
                'title' => 'Assign course to session',
                'slug' => 'session:assigncourse',
                'description' => 'Assign a course to a session',
            ],
            [
                'title' => 'Edit site settings',
                'slug' => 'site:editsettings',
                'description' => 'Manage settings of the platform',
            ],
            [
                'title' => 'Access site maintenance',
                'slug' => 'site:maintenanceaccess',
                'description' => 'Access site maintenance',
            ],
            [
                'title' => 'Manage course competency',
                'slug' => 'skill:coursecompetencymanage',
                'description' => 'Assign skills through course grade books',
            ],
            [
                'title' => 'Review user competency',
                'slug' => 'skill:usercompetencyreview',
                'description' => 'Add comments on other user\'s acquired skills',
            ],
            [
                'title' => 'Assign skill',
                'slug' => 'skill:assign',
            ...
            [
                'title' => 'View skill',
                'slug' => 'skill:view',
                'description' => 'View all skills acquired by users in manager\'s context',
            ],
            [
                'title' => 'View all skills',
                'slug' => 'skill:viewall',
                'description' => 'View all skills acquired by users of the platform',
            ],
            [
                'title' => 'Create survey',
                'slug' => 'survey:create',
                'description' => 'Create surveys (global or inside own course)',
            ],
            [
                'title' => 'Delete survey',
                'slug' => 'survey:delete',
            ...
            [
                'title' => 'Submit survey',
                'slug' => 'survey:submit',
                'description' => 'Submit surveys',
            ],
            [
                'title' => 'View survey results',
                'slug' => 'survey:viewresults',
            ...
            [
                ...
                'slug' => 'ticket:manage',
                'description' => 'Manage the tickets system',
            ],
            [
                'title' => 'Report ticket',
                'slug' => 'ticket:report',
                'description' => 'Create tickets (most users should be able to report issues)',
            ],
            [
                'title' => 'See ticket issues',
                'slug' => 'ticket:seeissues',
                'description' => 'See issue details for issues where user\'s involved',
            ],
            [
                'title' => 'View all ticket issues',
                'slug' => 'ticket:viewallissues',
                'description' => 'View all issues',
            ],
            [
                'title' => 'Edit tool visibility',
                'slug' => 'tool:editvisibility',
                'description' => 'Allow setting the visibility of a tool in a course',
            ],
            [
                'title' => 'Manage URL',
                'slug' => 'url:manage',
                'description' => 'Manage Multi-URL configuration',
            ],
            [
                'title' => 'Assign classes to URL',
                'slug' => 'url:assignclass',
                'description' => 'Assign classes to URL',
            ],
            [
                'title' => 'Assign courses to URL',
                'slug' => 'url:assigncourse',
                'description' => 'Assign courses to URL',
            ],
            [
                'title' => 'Assign users to URL',
                'slug' => 'url:assignuser',
                'description' => 'Assign users to URL',
            ],
            [
                'title' => 'Assign user to course',
                'slug' => 'user:assigncourse',
                'description' => 'Assign a user to a course',
            ],
            [
                'title' => 'Assign user to session',
                'slug' => 'user:assignsession',
                'description' => 'Assign a user to a session',
            ],
            [
                'title' => 'Create user',
                'slug' => 'user:create',
            ...
            [
                ...
                'slug' => 'course:editsettings',
                'description' => 'Edit settings of a course',
            ],
        ];
    }
