        ...
        foreach ($extraFields as $extraField) {
            ...
            switch ($extraField->getValueType()) {
                ...
                case \ExtraField::FIELD_TYPE_TAG:
                    ...
                    if ($extraFieldType === ExtraField::USER_FIELD_TYPE) {
                ...
                case \ExtraField::FIELD_TYPE_SELECT_MULTIPLE:
                    if (empty($value)) {
                        $defaultOptions['data'] = null;
                        if ($extraField->getValueType() === \ExtraField::FIELD_TYPE_CHECKBOX) {
                            $defaultOptions['data'] = [];
                        }
                    }
                    ...
                    if ($extraField->getValueType() === \ExtraField::FIELD_TYPE_SELECT) {
                        $defaultOptions['expanded'] = false;
                        $defaultOptions['multiple'] = false;
                    }
                    if ($extraField->getValueType() === \ExtraField::FIELD_TYPE_SELECT_MULTIPLE) {
                        $defaultOptions['expanded'] = false;
                        $defaultOptions['multiple'] = true;
                    }
                    $builder->add($variable, ChoiceType::class, $defaultOptions);
