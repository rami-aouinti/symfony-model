...
use App\CoreBundle\ApiResource\CategorizedExerciseResult;
use App\CoreBundle\Security\Authorization\Voter\TrackEExerciseVoter;
    ...
    private function displayQuestionListByAttempt(
        ...
        if (($show_results || $show_only_score) && $showTotalScore) {
            if (
                ...
                && $result['answer_type'] !== MULTIPLE_ANSWER_TRUE_FALSE_DEGREE_CERTAINTY
            ) {
                $pluginEvaluation = QuestionOptionsEvaluationPlugin::create();
                if ($pluginEvaluation->get(QuestionOptionsEvaluationPlugin::SETTING_ENABLE) === 'true') {
        ...
        if (!$show_results && !$show_only_score && $objExercise->results_disabled !== RESULT_DISABLE_RADAR) {
