...
class SessionVoter extends Voter
{
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        switch ($attribute) {
            case self::VIEW:
                ...
                if ($userIsStudent && $visibilityForUser == Session::LIST_ONLY) {
                    return false;
                }
    ...
    private function allowToManageSessions(): bool
    {
        ...
        return $setting === 'true' && $this->security->isGranted('ROLE_TEACHER');
    }
    ...
    private function allowed(User $user, Session $session): bool
    {
        ...
        if (
            ...
            && $this->settingsManager->getSetting('session.allow_teachers_to_create_sessions') === 'true'
