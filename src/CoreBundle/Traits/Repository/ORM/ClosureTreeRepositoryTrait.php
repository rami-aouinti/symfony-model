...
trait ClosureTreeRepositoryTrait
{
     ...
     *
     * @return QueryBuilder - list of given $node parents, null on failure
     */
    public function closureLocateQueryBuilder(string $way = 'down', object $node = null, bool $direct = false, string $sortByField = null, string $direction = 'ASC', bool $includeNode = false): QueryBuilder
    {
        switch ($way) {
            case 'down':
                $first = 'ancestor';
     ...
     */
    public function childrenQueryBuilder($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false): QueryBuilder
    {
     ...
     */
    public function childrenQuery($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false): Query
    {
     ...
     */
    public function ancestorsQueryBuilder($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false): QueryBuilder
    {
     ...
     */
    public function ancestorsQuery($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false): Query
    {
     ...
     */
    public function getAncestorsQueryBuilder($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false): QueryBuilder
    {
    ...
    public function getNodesHierarchyQueryBuilder($node = null, $direct = false, array $options = [], $includeNode = false)
    {
        ...
        if (
            isset($options['childSort']) && is_array($options['childSort']) &&
