...
use App\Platform\Domain\Entity\HookCall;
use Database;
...
class HookManagement
{
    ...
    public function listAllHookObservers()
    {
        ...
        /** @var \App\Platform\Domain\Entity\HookObserver $hookObserver */
    ...
    public function listAllHookEvents()
    {
        ...
        /** @var \App\Platform\Domain\Entity\HookEvent $hookEvent */
    ...
    public function insertHookIfNotExist($eventName = null, $observerClassName = null)
    {
        ...
        if (isset($eventName) && !isset($this->hookEvents[$eventName])) {
            $hookEvent = new \App\Platform\Domain\Entity\HookEvent();
            $hookEvent
        ...
        if (
            ...
            $hookObserver = new \App\Platform\Domain\Entity\HookObserver();
            $hookObserver
