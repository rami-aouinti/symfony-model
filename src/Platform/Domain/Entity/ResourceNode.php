...
use App\CoreBundle\Entity\Listener\ResourceNodeListener;
use App\CoreBundle\Entity\User\User;
use App\CoreBundle\Entity\User\Usergroup;
use App\CoreBundle\Repository\ResourceNodeRepository;
use App\CoreBundle\Traits\TimestampableAgoTrait;
use App\CoreBundle\Traits\TimestampableTypedEntity;
...
class ResourceNode implements Stringable
{
    ...
    #[Assert\NotNull]
    #[ORM\ManyToOne(targetEntity: ResourceType::class, cascade: ['persist'], inversedBy: 'resourceNodes')]
     ...
     *
     * ORM\OneToOne(targetEntity="App\CoreBundle\Entity\Illustration", mappedBy="resourceNode")
     */
    ...
    public function convertPathForDisplay(string $path): string
    {
        ...
        if ($pathForDisplay !== null && $pathForDisplay !== '') {
    ...
    {
        $resourceFile = $this->resourceFiles->first();
        if ($resourceFile) {
