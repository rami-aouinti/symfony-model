...
use App\CoreBundle\Controller\CreateResourceFileAction;
use App\CoreBundle\Repository\ResourceFileRepository;
use ArrayObject;
use DateTime;
    ...
    operations: [
        ...
        new Post(
            ...
            openapi: new Operation(
                ...
                description: 'Allows users to upload a resource file in binary format.',
                    ...
                    content: new ArrayObject([
                        'multipart/form-data' => [
                            'schema' => [
                                ...
                                'required' => ['file'], // Champs obligatoires
                            ],
                        ],
                    ])
                )
