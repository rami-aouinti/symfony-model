...
abstract class AbstractResource
{
    ...
    {
        return $this->parentResourceNode !== null && $this->parentResourceNode !== 0;
    }
    ...
    public function isVisible(Course $course, ?Session $session = null): bool
    {
        ...
        if ($link === null && $this instanceof ResourceShowCourseResourcesInSessionInterface) {
        ...
        return $link->getVisibility() === ResourceLink::VISIBILITY_PUBLISHED;
    }
