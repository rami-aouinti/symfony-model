...
{
    final public const int COLORS_MAX = 16_777_215;
     ...
     * @throws Exception
     */
    public static function createGdImageFromFilename(string $filename, ?int $backgroundColor = null): self
    {
     ...
     * @throws Exception
     */
    public static function createPaletteFromGdImage(GdImage $image, ?int $backgroundColor = null): self
    {
