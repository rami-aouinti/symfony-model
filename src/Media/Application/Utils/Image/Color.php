...
namespace App\Media\Application\Utils\Image;
...
class Color
{
     ...
     */
    #[ArrayShape([
        self::COLOR_INDEX_RGB_RED => 'int',
        self::COLOR_INDEX_RGB_GREEN => 'int',
        self::COLOR_INDEX_RGB_BLUE => 'int',
    ])]
     ...
     */
    #[ArrayShape([
        self::COLOR_INDEX_LAB_LIGHTNESS => 'float',
        self::COLOR_INDEX_LAB_A => 'float',
        self::COLOR_INDEX_LAB_B => 'float',
    ])]
     ...
     */
    #[ArrayShape([
        self::COLOR_INDEX_SRGB_RED => 'float',
        self::COLOR_INDEX_SRGB_GREEN => 'float',
        self::COLOR_INDEX_SRGB_BLUE => 'float',
    ])]
     ...
     */
    #[ArrayShape([
        self::COLOR_INDEX_XYZ_X => 'float',
        self::COLOR_INDEX_XYZ_Y => 'float',
        self::COLOR_INDEX_XYZ_Z => 'float',
    ])]
