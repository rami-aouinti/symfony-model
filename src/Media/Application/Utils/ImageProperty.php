...
namespace App\Media\Application\Utils;
...
class ImageProperty
{
    ...
    final public const string PATH_TESTS = 'tests';
    ...
    public function __construct(
        ...
        protected ?PlaceLoaderService $placeLoaderService = null,
        protected ?LocationDataService $locationDataService = null
    ) {
        /* Set root path. */
