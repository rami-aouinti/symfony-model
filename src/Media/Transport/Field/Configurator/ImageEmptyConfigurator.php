...
namespace App\Media\Transport\Field\Configurator;

use App\Media\Transport\Field\ImageEmptyField;
 ...
 * @package App\Field
 */
final readonly class ImageEmptyConfigurator implements FieldConfiguratorInterface
{
    ...
    {
        return $field->getFieldFqcn() === ImageEmptyField::class;
    }
    ...
    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        ...
        if (!is_string($configuredBasePath) && $configuredBasePath !== null) {
    ...
    private function getImagePath(string $imagePath, ?string $basePath): string
    {
        ...
        if (preg_match('/^(http[s]?|\/\/)/i', $imagePath) !== 0) {
            return $imagePath;
        }
