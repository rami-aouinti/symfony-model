...
namespace App\Media\Transport\Field;

use App\Media\Domain\Entity\Image;
use App\Media\Transport\Form\Type\FileUploadEmptyType;
use Closure;
...
final class ImageEmptyField implements FieldInterface
{
    ...
    public const string OPTION_BASE_PATH = 'basePath';
    public const string OPTION_UPLOAD_DIR = 'uploadDir';
    public const string OPTION_UPLOADED_FILE_NAME_PATTERN = 'uploadedFileNamePattern';
