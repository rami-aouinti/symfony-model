...
#[Index(columns: ['social_post_id', 'user_id'], name: 'idx_social_post_uid_spid')]
#[ORM\Entity]
class SocialPostFeedback
{
    use UserTrait;
    ...
    #[ORM\Column(name: 'liked', type: 'boolean', options: [
        'default' => false,
    ])]
    protected bool $liked;

    #[ORM\Column(name: 'disliked', type: 'boolean', options: [
        'default' => false,
    ])]
