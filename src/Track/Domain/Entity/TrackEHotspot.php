...
#[ORM\Index(columns: ['hotspot_user_id'], name: 'hotspot_user_id')]
#[ORM\Index(columns: ['hotspot_exe_id'], name: 'hotspot_exe_id')]
#[ORM\Index(columns: ['hotspot_question_id'], name: 'hotspot_question_id')]
#[ORM\Entity]
class TrackEHotspot
{
    use CourseTrait;
