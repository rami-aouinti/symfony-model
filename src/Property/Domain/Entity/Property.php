...
use App\Place\Domain\Entity\Traits\EntityLocationTrait;
use App\Platform\Domain\Entity\Traits\EntityIdTrait;
use App\Platform\Domain\Entity\Traits\EntityTimestampableTrait;
...
class Property
{
    ...
    final public const string INVERSED_BY = 'properties';
