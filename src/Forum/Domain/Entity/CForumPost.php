...
#[ORM\Index(columns: ['thread_id'], name: 'idx_forum_post_thread_id')]
#[ORM\Index(columns: ['visible'], name: 'idx_forum_post_visible')]
...
class CForumPost extends AbstractResource implements ResourceInterface, Stringable
{
     ...
     * @var Collection
     */
    #[ORM\OneToMany(mappedBy: 'postParent', targetEntity: self::class)]
    protected Collection $children;

    /**
     * @var Collection
     */
    #[ORM\OneToMany(mappedBy: 'post', targetEntity: CForumAttachment::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
