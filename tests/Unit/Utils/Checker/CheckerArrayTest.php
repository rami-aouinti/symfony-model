 ...
 * @link \App\Platform\Application\Utils\Checker\CheckerArray
 */
final class CheckerArrayTest extends TestCase
{
     ...
     */
    public function testWrapperCheck(int $number, string $method, mixed $data, string $parameter, mixed $expected, ?string $exceptionClass): void
    {
        /* Arrange */
     ...
     * @link \App\Platform\Application\Utils\Checker\CheckerArray::checkPriceAbstract()
     */
