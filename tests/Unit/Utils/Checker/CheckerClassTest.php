 ...
 * @link \App\Platform\Application\Utils\Checker\CheckerClass
 */
final class CheckerClassTest extends TestCase
{
     ...
     * @link         \App\Platform\Application\Utils\Checker\CheckerClass
     */
    public function testWrapperCheck(int $number, string $method, mixed $data, string|null $className, string|null $exceptionClass): void
    {
        /* Arrange */
     ...
     * @link \App\Platform\Application\Utils\Checker\CheckerClass::checkGiven()
     * @link \App\Platform\Application\Utils\Checker\CheckerClass::checkStdClass()
     */
