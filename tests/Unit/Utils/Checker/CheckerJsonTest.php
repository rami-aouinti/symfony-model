 ...
 * @link \App\Platform\Application\Utils\Checker\CheckerJson
 */
final class CheckerJsonTest extends TestCase
{
     ...
     * @link \App\Platform\Application\Utils\Checker\CheckerJson::checkJson()
     */
     ...
     * @throws TypeInvalidException
     */
    public function testWrapperIs(int $number, string $method, mixed $data, bool $expected): void
    {
        /* Arrange */
     ...
     * @link \App\Platform\Application\Utils\Checker\CheckerJson::isJson()
     */
