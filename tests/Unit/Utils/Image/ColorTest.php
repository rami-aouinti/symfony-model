...
final class ColorTest extends TestCase
{
     ...
     */
    public function testWrapper(int $number, string $method, string|int|float|bool|array $param1, string|int|bool|null $param2, string|int|bool|null $param3, string|int|bool|null $param4, string|int|bool|null $param5, string|int|float|array $expected): void
    {
        /* Arrange */
    ...
    public function dataProvider(): array
    {
        ...
        return [
             ...
             */
            [
                ++$number, 'convertIntToRgbArray', Color::convertRgbsToInt(0, 0, 0), null, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 0,
                    Color::COLOR_INDEX_RGB_GREEN => 0,
                    Color::COLOR_INDEX_RGB_BLUE => 0,
                ]],
            [
                ++$number, 'convertIntToRgbArray', Color::convertRgbsToInt(128, 128, 128), null, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 128,
                    Color::COLOR_INDEX_RGB_GREEN => 128,
                    Color::COLOR_INDEX_RGB_BLUE => 128,
                ]],
            [
                ++$number, 'convertIntToRgbArray', Color::convertRgbsToInt(255, 255, 255), null, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 255,
                    Color::COLOR_INDEX_RGB_GREEN => 255,
                    Color::COLOR_INDEX_RGB_BLUE => 255,
                ]],
             ...
             */
            [
                ++$number, 'convertIntToLabArray', Color::convertRgbsToInt(0, 0, 0), 6, null, null, null, [
                    Color::COLOR_INDEX_LAB_LIGHTNESS => 0.,
                    Color::COLOR_INDEX_LAB_A => 0.,
                    Color::COLOR_INDEX_LAB_B => 0.,
                ]],
            [
                ++$number, 'convertIntToLabArray', Color::convertRgbsToInt(128, 128, 128), 6, null, null, null, [
                    Color::COLOR_INDEX_LAB_LIGHTNESS => 53.585016,
                    Color::COLOR_INDEX_LAB_A => -1.E-5,
                    Color::COLOR_INDEX_LAB_B => 4.E-6,
                ]],
            [
                ++$number, 'convertIntToLabArray', Color::convertRgbsToInt(255, 255, 255), 6, null, null, null, [
                    Color::COLOR_INDEX_LAB_LIGHTNESS => 100.,
                    Color::COLOR_INDEX_LAB_A => -1.7E-5,
                    Color::COLOR_INDEX_LAB_B => 7.E-6,
                ]],
             ...
             */
            [
                ++$number, 'convertHexToRgbArray', '#000000', null, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 0,
                    Color::COLOR_INDEX_RGB_GREEN => 0,
                    Color::COLOR_INDEX_RGB_BLUE => 0,
                ]],
            [
                ++$number, 'convertHexToRgbArray', '#808080', true, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 128,
                    Color::COLOR_INDEX_RGB_GREEN => 128,
                    Color::COLOR_INDEX_RGB_BLUE => 128,
                ]],
            [
                ++$number, 'convertHexToRgbArray', '#FFFFFF', true, null, null, null, [
                    Color::COLOR_INDEX_RGB_RED => 255,
                    Color::COLOR_INDEX_RGB_GREEN => 255,
                    Color::COLOR_INDEX_RGB_BLUE => 255,
                ]],
             ...
             */
            [++$number, 'convertRgbArrayToInt', [
                Color::COLOR_INDEX_RGB_RED => 0,
                Color::COLOR_INDEX_RGB_GREEN => 0,
                Color::COLOR_INDEX_RGB_BLUE => 0,
            ], null, null, null, null, Color::convertRgbsToInt(0, 0, 0)],
            [++$number, 'convertRgbArrayToInt', [
                Color::COLOR_INDEX_RGB_RED => 128,
                Color::COLOR_INDEX_RGB_GREEN => 128,
                Color::COLOR_INDEX_RGB_BLUE => 128,
            ], null, null, null, null, Color::convertRgbsToInt(128, 128, 128)],
            [++$number, 'convertRgbArrayToInt', [
                Color::COLOR_INDEX_RGB_RED => 255,
                Color::COLOR_INDEX_RGB_GREEN => 255,
                Color::COLOR_INDEX_RGB_BLUE => 255,
            ], null, null, null, null, Color::convertRgbsToInt(255, 255, 255)],

            /**
             * Test: convertRgbArrayToHex
             */
            [++$number, 'convertRgbArrayToHex', [
                Color::COLOR_INDEX_RGB_RED => 0,
                Color::COLOR_INDEX_RGB_GREEN => 0,
                Color::COLOR_INDEX_RGB_BLUE => 0,
            ], null, null, null, null, '#000000'],
            [++$number, 'convertRgbArrayToHex', [
                Color::COLOR_INDEX_RGB_RED => 128,
                Color::COLOR_INDEX_RGB_GREEN => 128,
                Color::COLOR_INDEX_RGB_BLUE => 128,
            ...
            [++$number, 'convertRgbArrayToHex', [
                ...
                Color::COLOR_INDEX_RGB_GREEN => 255,
                Color::COLOR_INDEX_RGB_BLUE => 255,
            ], false, null, null, null, 'FFFFFF'],
            [++$number, 'convertRgbArrayToHex', [
                Color::COLOR_INDEX_RGB_RED => 255,
                Color::COLOR_INDEX_RGB_GREEN => 255,
                Color::COLOR_INDEX_RGB_BLUE => 255,
            ], true, true, null, null, '#ffffff'],
            [++$number, 'convertRgbArrayToHex', [
                Color::COLOR_INDEX_RGB_RED => 255,
                Color::COLOR_INDEX_RGB_GREEN => 255,
                Color::COLOR_INDEX_RGB_BLUE => 255,
            ], false, true, null, null, 'ffffff'],

            /**
             * Test: convertRgbArrayToSrgbArray
             */
            [
                ++$number, 'convertRgbArrayToSrgbArray', [
                    Color::COLOR_INDEX_RGB_RED => 0,
                    Color::COLOR_INDEX_RGB_GREEN => 0,
                    Color::COLOR_INDEX_RGB_BLUE => 0,
                ], 6, null, null, null, [
                    Color::COLOR_INDEX_SRGB_RED => 0.,
                    Color::COLOR_INDEX_SRGB_GREEN => 0.,
                    Color::COLOR_INDEX_SRGB_BLUE => 0.,
                ]],
            [
                ++$number, 'convertRgbArrayToSrgbArray', [
                    Color::COLOR_INDEX_RGB_RED => 128,
                    ...
                    Color::COLOR_INDEX_SRGB_RED => 0.215861,
                    Color::COLOR_INDEX_SRGB_GREEN => 0.215861,
                    Color::COLOR_INDEX_SRGB_BLUE => 0.215861,
                ]],
            [
                ++$number, 'convertRgbArrayToSrgbArray', [
                    Color::COLOR_INDEX_RGB_RED => 255,
                    ...
                    Color::COLOR_INDEX_SRGB_RED => 1.,
                    Color::COLOR_INDEX_SRGB_GREEN => 1.,
                    Color::COLOR_INDEX_SRGB_BLUE => 1.,
                ]],
             ...
             */
            [
                ++$number, 'convertSrgbArrayToXyzArray', [
                    Color::COLOR_INDEX_SRGB_RED => 0.,
                    Color::COLOR_INDEX_SRGB_GREEN => 0.,
                    Color::COLOR_INDEX_SRGB_BLUE => 0.,
                ], 6, null, null, null, [
                    Color::COLOR_INDEX_XYZ_X => 0.,
                    Color::COLOR_INDEX_XYZ_Y => 0.,
                    Color::COLOR_INDEX_XYZ_Z => 0.,
                ]],
            [
                ++$number, 'convertSrgbArrayToXyzArray', [
                    Color::COLOR_INDEX_SRGB_RED => 0.215861,
                    ...
                    Color::COLOR_INDEX_XYZ_X => 0.205169,
                    Color::COLOR_INDEX_XYZ_Y => 0.215861,
                    Color::COLOR_INDEX_XYZ_Z => 0.235036,
                ]],
            [
                ++$number, 'convertSrgbArrayToXyzArray', [
                    Color::COLOR_INDEX_SRGB_RED => 1.,
                    ...
                    Color::COLOR_INDEX_XYZ_X => 0.95047,
                    Color::COLOR_INDEX_XYZ_Y => 1.,
                    Color::COLOR_INDEX_XYZ_Z => 1.08883,
                ]],
             ...
             */
            [
                ++$number, 'convertXyzArrayToLabArray', [
                    Color::COLOR_INDEX_XYZ_X => 0.,
                    Color::COLOR_INDEX_XYZ_Y => 0.,
                    Color::COLOR_INDEX_XYZ_Z => 0.,
                ], 6, null, null, null, [
            ...
            [
                ++$number, 'convertXyzArrayToLabArray', [
                    ...
                    Color::COLOR_INDEX_LAB_LIGHTNESS => 53.585067,
                    Color::COLOR_INDEX_LAB_A => -0.000197,
                    Color::COLOR_INDEX_LAB_B => -1.1E-5,
                ]],
            [
                ++$number, 'convertXyzArrayToLabArray', [
                    Color::COLOR_INDEX_XYZ_X => 0.95047,
