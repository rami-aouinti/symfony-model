...
final class GPSConverterTest extends TestCase
{
     ...
     */
    public function testWrapper(int $number, string $method, string|float $given1, string|float|null $given2, float|array|string $expected, string $parameter1 = null, string $parameter2 = null, string $parameter3 = null): void
    {
        /* Arrange */
    ...
    public function dataProvider(): array
    {
        ...
        return [
             ...
             */
            [
                ++$number, 'parseDms', '79°51’27.4392"E', null, [
                    'degree' => 79,
                    'minutes' => 51,
                    'seconds' => 27.4392,
                    'type' => Coordinate::TYPE_LONGITUDE,
                    'direction' => Coordinate::DIRECTION_EAST,
                ]],
            [
                ++$number, 'parseDms', '79°51\'27.4392"E', null, [
                    'degree' => 79,
            ...
            [
                ++$number, 'parseDms', '008°00′55.60″E', null, [
                    'degree' => 8,
                    'minutes' => 0,
                    'seconds' => 55.6,
                    'type' => Coordinate::TYPE_LONGITUDE,
            ...
            [
                ++$number, 'parseDms', 'E008°00′55.60″', null, [
                    'degree' => 8,
                    'minutes' => 0,
                    'seconds' => 55.6,
                    'type' => Coordinate::TYPE_LONGITUDE,
             ...
             */
            [
                ++$number, 'parseDms', '6°55’57"N', null, [
                    'degree' => 6,
                    'minutes' => 55,
                    'seconds' => 57.,
                    'type' => Coordinate::TYPE_LATITUDE,
                    'direction' => Coordinate::DIRECTION_NORTH,
                ]],
            [
                ++$number, 'parseDms', '6°55\'57"N', null, [
                    'degree' => 6,
            ...
            [
                ++$number, 'parseDms', '46°14′06.70″N', null, [
                    'degree' => 46,
                    'minutes' => 14,
                    'seconds' => 6.70,
                    'type' => Coordinate::TYPE_LATITUDE,
            ...
            [
                ++$number, 'parseDms', 'N46°14′06.70″', null, [
                    'degree' => 46,
                    'minutes' => 14,
                    'seconds' => 6.70,
                    'type' => Coordinate::TYPE_LATITUDE,
             ...
             */
            [
                ++$number, 'parseDecimalDegree',  6.932500, null, [
                    'degree' => 6,
                    'minutes' => 55,
                    'seconds' => 57.,
                    'decimal' => 6.9325,
            ...
            [
                ++$number, 'parseDecimalDegree',  8.015444, null, [
                    'degree' => 8,
                    'minutes' => 0,
                    'seconds' => 55.5984,
                    'decimal' => 8.015444,
            ...
            [
                ++$number, 'parseDecimalDegree', 46.235194, null, [
                    'degree' => 46,
                    'minutes' => 14,
                    'seconds' => 6.6984,
                    'decimal' => 46.235194,
            ...
            [
                ++$number, 'parseDecimalDegree', 79.857622, null, [
                    'degree' => 79,
                    'minutes' => 51,
                    'seconds' => 27.4392,
                    'decimal' => 79.857622,
             ...
             */
            [
                ++$number, 'dms2DecimalDegrees', '79°51’27.4392"E', '6°55’57"N',  [
                    'longitude' => 79.857622,
                    'latitude' => 6.932500,
                ]],
            [
            ...
            [
                ++$number, 'dms2DecimalDegrees', '008°00′55.60″E', '46°14′06.70″N', [
                    'longitude' => 8.015444,
                    'latitude' => 46.235194,
                ]],
            [
                ++$number, 'dms2DecimalDegrees', 'E008°00′55.60″', 'N46°14′06.70″', [
                    'longitude' => 8.015444,
                    'latitude' => 46.235194,
                ]],
             ...
             */
            [
                ++$number, 'decimalDegree2dmss', 79.857622, 6.932500, [
                    'longitude' => '79°51′27.4392″',
                    'latitude' => '6°55′57″',
                ]],
            [++$number, 'decimalDegree2dmss', 79.857622, 6.932500, [
                'longitude' => '79°51′27.4392″E',
                'latitude' => '6°55′57″N',
            ], Coordinate::DIRECTION_EAST, Coordinate::DIRECTION_NORTH],
            [++$number, 'decimalDegree2dmss', 79.857622, 6.932500, [
                'longitude' => '79°51′27.4392″E',
                'latitude' => '6°55′57″N',
            ], Coordinate::DIRECTION_EAST, Coordinate::DIRECTION_NORTH, GPSPosition::FORMAT_DMS_SHORT_1],
            [++$number, 'decimalDegree2dmss', 79.857622, 6.932500, [
                'longitude' => 'E79°51′27.4392″',
                'latitude' => 'N6°55′57″',
            ], Coordinate::DIRECTION_EAST, Coordinate::DIRECTION_NORTH, GPSPosition::FORMAT_DMS_SHORT_2],
