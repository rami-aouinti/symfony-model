...
{
    protected const string PATH_ROOT = '/path/to/root';
     ...
     * @throws Exception
     */
    public function testWrapper(int $number, string $method, mixed $param1, mixed $param2, mixed $param3, mixed $param4, mixed $param5, mixed $param6, string $given, string $expected): void
    {
        /* Arrange */
