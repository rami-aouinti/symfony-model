...
final class JsonTest extends TestCase
{
     ...
     * @throws Exception
     */
    public function testWrapperGetArray(int $number, string|object|array $data, array|string $expected): void
    {
        /* Arrange */
     ...
     * @throws Exception
     */
    public function testWrapperAddJson(int $number, string|object|array $data, string|object|array $dataAdd, string|array|null $path, array|string $expected): void
    {
        /* Arrange */
        if (is_string($expected)) {
            $this->expectException($expected);
    ...
    public function dataProviderAddJson(): array
    {
        ...
        return [
            ...
            [++$number, '[1, 2, 3]', '{"first": 1, "second": 2, "third": 3}', null, [
                1,
                2,
                3,
                'first' => 1,
            ...
            [++$number, '[1, 2, 3]', new Json('{"first": 1, "second": 2, "third": 3}'), null, [
                1,
                2,
                3,
                'first' => 1,
            ...
            [++$number, '{"version": "1.0.0", "data": []}', '{"field1": "1", "field2": 2}', null, [
                'version' => '1.0.0',
                'data' => [],
                'field1' => '1',
                'field2' => 2,
            ], ],
            [++$number, '{"version": "1.0.0", "data": []}', '{"field1": "1", "field2": 2}', '', [
                'version' => '1.0.0',
                'data' => [],
                'field1' => '1',
                'field2' => 2,
            ], ],
            [++$number, '{"version": "1.0.0", "data": []}', '{"field1": "1", "field2": 2}', 'data', [
                'version' => '1.0.0',
                'data' => [
                    'field1' => '1',
                    'field2' => 2,
            ...
            [
                ++$number, '{"version": "1.0.0", "data": []}', '{"field1": "1", "field2": 2}', 'data.test', [
                    'version' => '1.0.0',
                    'data' => [
                        'test' => [
                            'field1' => '1',
            ...
            [
                ++$number, '{"version": "1.0.0", "data": []}', '{"field1": "1", "field2": [1, 2, [3, 4, 5]]}', ['data', 'test'], [
                    'version' => '1.0.0',
                    'data' => [
                        'test' => [
                            'field1' => '1',
            ...
            [++$number, '{"version": "1.0.0", "data": []}', '{"version": "1.0.0", "data": []}', null, [
                'version' => '1.0.0',
                'data' => [],
            ], ],
        ];
