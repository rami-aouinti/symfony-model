...
final class UrlServiceTest extends TestCase
{
     ...
     */
    public function testWrapperEncode(int $number, string $method, array $config, array $given, bool $withPath, bool $short, string $expected): void
    {
        /* Arrange */
     ...
     */
    public function testWrapperDecode(int $number, string $method, array $config, string $path, array $expected): void
    {
        /* Arrange */
